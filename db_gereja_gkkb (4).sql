...
--
-- Host: localhost:3306
-- Generation Time: Jul 12, 2026 at 08:28 AM
...
INSERT INTO `tb_doa` (`id_doa`, `nama_lengkap`, `isi_doa`, `tanggal_kirim`, `id_user`) VALUES
(1, 'yoas', 'UAS GACORR', '2026-07-12 08:16:56', NULL);
...
(5, 'ultah.jpeg', 1),
(6, 'photo1.jpeg', 1),
(8, 'img_6a534271c1bc81.14747849.jpeg', 1);
...
INSERT INTO `tb_jadwal` (`id_jadwal`, `hari`, `nama_kegiatan`, `jam_mulai`, `id_user`) VALUES
(1, 'Jumat', 'Paskah', '12:30:00', 1);
...
--
-- Dumping data for table `tb_pendeta`
--

INSERT INTO `tb_pendeta` (`id_pendeta`, `foto_pendeta`, `nama_pendeta`, `biodata`, `id_user`) VALUES
(1, 'img_6a534e53ab6ed1.73008816.jpeg', 'Djong Tsiu Hiong', 'tessssssssssssssssssssssssssssssssssssssssssssssssssssssss', 1);
...
(12, 'test', 'test1', 'foto-renungan.jpg', '2026-06-18 10:58:21', 1, 'https://warungsatekamu.org/renungan/');
...
--
ALTER TABLE `tb_doa`
  MODIFY `id_doa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_pendeta`
  MODIFY `id_pendeta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
